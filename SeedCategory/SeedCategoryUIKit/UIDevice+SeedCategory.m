//
//  UIDevice+SeedCategory.m
//  SeedCategory
//
//  Created by Hao on 2020/10/24.
//

#import "UIDevice+SeedCategory.h"
...
@implementation UIDevice (SeedCategory)
...
- (SeedDeviceType)s_deviceType {
    ...
    SeedDeviceType model = [UIDevice.currentDevice s_deviceType];
...
- (SeedDeviceModel)s_deviceModel {
    ...
    if ([machine isEqualToString:@"iPad1,1"]) {
    ...
    } else if ([machine isEqualToString:@"iPad7,11"]) {
        
        return iPad_7_WiFi;
    } else if ([machine isEqualToString:@"iPad7,12"]) {
        
        return iPad_7_Cellular;
        ...
        return iPad_Pro_2_11_WiFi;
    } else if ([machine isEqualToString:@"iPad8,10"]) {
        
        return iPad_Pro_2_11_Cellular;
    } else if ([machine isEqualToString:@"iPad8,11"]) {
        
        return iPad_Pro_4_129_WiFi;
    } else if ([machine isEqualToString:@"iPad8,12"]) {
        
        return iPad_Pro_4_129_Cellular;
    ...
    } else if ([machine isEqualToString:@"iPad11,6"]) {
        
        return iPad_8_WiFi;
    } else if ([machine isEqualToString:@"iPad11,7"]) {
        
        return iPad_8_Cellular;
    } else if ([machine isEqualToString:@"iPad13,1"]) {
        
        return iPad_Air_4_WiFi;
    } else if ([machine isEqualToString:@"iPad13,2"]) {
        
        return iPad_Air_4_Cellular;
    }
    ...
    if ([machine isEqualToString:@"Watch1,1"]) {
        ...
        return Apple_Watch_5_40MM;
    } else if ([machine isEqualToString:@"Watch5,2"]) {
        
        return Apple_Watch_5_44MM;
    } else if ([machine isEqualToString:@"Watch5,3"]) {
        
        return Apple_Watch_5_40MM_LTE;
    } else if ([machine isEqualToString:@"Watch5,4"]) {
        
        return Apple_Watch_5_44MM_LTE;
    } else if ([machine isEqualToString:@"Watch5,9"]) {
        
        return Apple_Watch_SE_40MM;
    } else if ([machine isEqualToString:@"Watch5,10"]) {
        
        return Apple_Watch_SE_44MM;
    } else if ([machine isEqualToString:@"Watch5,11"]) {
        
        return Apple_Watch_SE_40MM_LTE;
    } else if ([machine isEqualToString:@"Watch5,12"]) {
        
        return Apple_Watch_SE_44MM_LTE;
    } else if ([machine isEqualToString:@"Watch6,1"]) {
        
        return Apple_Watch_6_40MM;
    } else if ([machine isEqualToString:@"Watch6,2"]) {
        
        return Apple_Watch_6_44MM;
    } else if ([machine isEqualToString:@"Watch6,3"]) {
        
        return Apple_Watch_6_40MM_LTE;
    } else if ([machine isEqualToString:@"Watch6,4"]) {
        
        return Apple_Watch_6_44MM_LTE;
    }
