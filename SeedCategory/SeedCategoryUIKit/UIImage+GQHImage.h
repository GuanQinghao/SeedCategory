...
/// 获取纯色图片
/// @param color 颜色
+ (nullable UIImage *)qh_imageWithColor:(UIColor *)color;
...
/// 截图/截屏
/// @param view 源视图
+ (nullable UIImage *)qh_imageFromView:(__kindof UIView *)view;

/// 带边框的圆形图片
/// @param borderWidth 边框宽度
/// @param borderColor 边框颜色
/// @param image 图片
+ (nullable UIImage *)qh_imageWithBorderWidth:(CGFloat)borderWidth borderColor:(UIColor *)borderColor image:(UIImage *)image;
...
/// @param rect 水印的位置
/// @param anImage 图片的水印
- (UIImage *)qh_watermarkInRect:(CGRect)rect image:(nullable UIImage *)anImage;

/// 添加文字水印
/// @param rect 水印位置
/// @param aString 图片的文字水印
- (UIImage *)qh_watermarkInRect:(CGRect)rect string:(nullable NSAttributedString *)aString;
