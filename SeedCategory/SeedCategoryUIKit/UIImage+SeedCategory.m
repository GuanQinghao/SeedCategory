//
//  UIImage+SeedCategory.m
//  SeedCategory
//
//  Created by Hao on 2020/10/24.
//

#import "UIImage+SeedCategory.h"
#import <AVFoundation/AVFoundation.h>
#import <ImageIO/ImageIO.h>


@implementation UIImage (SeedCategory)

/// 获取纯色图片
/// @param color 颜色
+ (UIImage *)s_imageWithColor:(UIColor *)color {
    
    return [self s_imageWithColor:color size:CGSizeMake(1.0f, 1.0f)];
}
...
+ (UIImage *)s_imageWithBase64:(NSString *)encode {
...
/// 截图/截屏
/// @param view 源视图
+ (UIImage *)s_imageFromView:(__kindof UIView *)view {
...
/// @param image 图片
+ (UIImage *)s_imageWithBorderWidth:(CGFloat)borderWidth borderColor:(UIColor *)borderColor image:(UIImage *)image {
...
/// @param interval 时刻(秒)
+ (UIImage *)s_screenshotForVideo:(NSString *)URLString at:(NSTimeInterval)interval {
...
/// 生成GIF图片
/// @param data gif数据
+ (UIImage *)s_animateGIFWithData:(NSData *)data {
...
- (UIImage *)s_imageFlipedWithDirection:(SeedFlipDirection)direction {
    ...
    switch (direction) {
        ...
        case SeedFlipDirectionVertical: {
            ...
            break;
        case SeedFlipDirectionHorizontal: {
...
/// 缩放图片到指定尺寸
/// @param size 指定尺寸
- (UIImage *)s_imageRescaledWithSize:(CGSize)size {
...
/// @param rect 水印的位置
/// @param anImage 图片的水印
- (UIImage *)s_watermarkInRect:(CGRect)rect image:(UIImage *)anImage {
...
- (UIImage *)s_watermarkInRect:(CGRect)rect string:(NSAttributedString *)aString {
