...
/// @param handler 弹窗操作处理
/// @param completion 弹窗完成后处理
- (void)qh_alertWithTitle:(NSString *)title message:(NSString *)message actionTitle:(NSString *)actionTitle handler:(void (^)(UIAlertAction * _Nullable))handler completion:(void (^)(void))completion {
...
/// @param completion 弹窗完成后处理
- (void)qh_alertWithTitle:(NSString *)title message:(NSString *)message actionTitles:(NSArray<NSString *> *)actionTitles handler:(void (^)(UIAlertAction * _Nullable, NSUInteger))handler completion:(void (^)(void))completion {
...
/// @param completion 弹窗完成后处理
- (void)qh_alertWithTitle:(NSString *)title message:(NSString *)message inputHandler:(void (^)(UITextField * _Nullable))inputHandler actionHandler:(void (^)(UIAlertAction * _Nullable, UIAlertController * _Nonnull))actionHandler completion:(void (^)(void))completion {
